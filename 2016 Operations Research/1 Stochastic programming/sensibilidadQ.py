...
file = open("resultadosQ.txt", "w")
Qo=[10,20,30,36,40,50,60,70,90,100,130,200]
global g
g=5

for k in Qo:
    global Q
    Q = k #cantidad de stock
    #-------------------------------------------------------------------------
    #funciones
    #-------------------------------------------------------------------------
    ...
    def ven(x,q,d,t):
        ...
        return x*b-cost(x)*x*b-g*c+v2(a,t)
    ...
    for t in range(1,T+1):
        ...
        for q in range (0,Q+1):
            ...
            if tiempo==1:
                ...
                #print q,": v*(q) = ",vo, " x = ", xo
                file.write(str(q) + ": v*(q) = " + str(vo) + " x = " + str(xo) + "\n")
    print "Stock: ",Q,"--> utilidad esperada = ",vector[(Q+1)*(T-1)+Q][1]
    file.write("Stock: "+str(Q)+"utilidad esperada = " + str(vector[(Q+1)*(T-1)+Q][1]) + "\n")
